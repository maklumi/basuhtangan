var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(div0, "class", "progress-bar svelte-z00bl4");
    			set_style(div0, "width", /*progress*/ ctx[0] + "%");
    			attr(div1, "bp", "offset-5@md 4@md 12@sm");
    			attr(div1, "class", "progress-container svelte-z00bl4");
    			attr(div2, "bp", "grid");
    		},
    		m(target, anchor) {
    ...
    function create_fragment$1(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(h2, "class", "svelte-17ixffq");
    			attr(div0, "bp", "grid");
    			button.disabled = /*isrunning*/ ctx[1];
    			attr(button, "vbp", "offset-5@md 4@md 12@sm");
    			attr(button, "class", "start svelte-17ixffq");
    			attr(div1, "bp", "grid");
    		},
    		...
    		p(ctx, [dirty]) {
    			if (!current || dirty & /*masatinggal*/ 1) set_data(t1, /*masatinggal*/ ctx[0]);
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	function handleClick() {
    		...
    		const pemasa = setInterval(
    			() => {
    				$$invalidate(0, masatinggal -= 1);

    				if (masatinggal == 0) {
    					$$invalidate(1, isrunning = false);
    					$$invalidate(0, masatinggal = totalmasa);
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*masatinggal*/ 1) {
    			 $$invalidate(2, progress = (totalmasa - masatinggal) / totalmasa * 100);
    		}
    	};

    	return [masatinggal, isrunning, progress, handleClick];
    }
    ...
    function create_fragment$2(ctx) {
    	...
    	return {
    		c() {
    			div = element("div");
    			div.innerHTML = `<img bp="offset-5@md 4@md 12@sm" src="basuhtangan.gif" alt="basuhtangan " class="svelte-1wsp3u5">`;
    			attr(div, "bp", "grid");
    		},
    		m(target, anchor) {
    ...
    function create_fragment$3(ctx) {
    	...
    	timer.$on("habis", /*handleHabis*/ ctx[1]);
    	const howto = new Howto({});

    	return {
    		c() {
    			h1 = element("h1");
    			h1.textContent = "Basuh Tangan";
    			t1 = space();
    			...
    			h3.innerHTML = `<a href="https://www.who.int/gpsc/clean_hands_protection/en/">Punca gambar</a> 
  <a href="https://freesound.org/people/metrostock99/sounds/345086/">
    Punca bunyi
    			...
    			if (audio_1.src !== (audio_1_src_value = "bunyiohyeah.wav")) attr(audio_1, "src", audio_1_src_value);
    		},
    		m(target, anchor) {
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	return [audio, handleHabis, audio_1_binding];
    }
